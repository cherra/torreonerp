...
<?php echo form_open($action, array('class' => 'form-horizontal', 'name' => 'form', 'id' => 'form', 'role' => 'form')) ?>
    ...
    <div class="form-group">
        <label class="control-label hidden-xs col-sm-4" for="filtro">Filtro</label>
        <div class="col-sm-8">
            <input type="text" name="filtro" id="filtro" placeholder="Filtro" class="form-control" value="<?php if(isset($filtro)) echo $filtro; ?>" >
        </div>
    </div>
    <div class="form-group">
...
$(document).ready(function(){
    ...
    $('form').validate({
        ...
        submitHandler: function(form){
            $('#form').attr('action',url+'/'+$('#desde').val()+'/'+$('#hasta').val()+'/'+$('#tipo').val());
