...
class informes extends CI_Controller {
    ...
    public function ventas_general( $exportar = NULL ){
        $data['reporte'] = '';
        $data['action'] = $this->folder.$this->clase.'ventas_general/';
        ...
        if( ($post = $this->input->post()) ){
            ...
            if(empty($exportar)){
                ...
                $this->tbs->VarRef['titulo'] = 'Reporte de ventas';
                ...
                //name the worksheet
                $this->excel->getActiveSheet()->setTitle('Reporte de ventas');
...
//                $this->excel->getActiveSheet()->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                ...
                $filename='reporte_de_ventas.xls'; //save our workbook as this file name
        ...
        $data['titulo'] = 'Reporte de ventas general <small>Listado</small>';
